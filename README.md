...
Relational databases are built using key-value pairs.
```

2. Why do tables need a Primary Key?

```
Having a primary key in a table ensures the ability to access and destinguish from each other entry.
```
...
```
You need to create a third table called a junction table that helps
to map between the two tables.
```
